...
```
crawl_duluth.py    index pages -> 356 documents, downloaded and hashed
extract_text.py    PDF text layer -> duluth_meeting_text.jsonl
ocr_scanned.py     the 91 documents with no usable text layer
...
python3 ingest/duluth_agendas/crawl_duluth.py            # downloads the PDFs
python3 ingest/duluth_agendas/extract_text.py
python3 ingest/duluth_agendas/ocr_scanned.py --pdf-dir raw/duluth_agendas --jobs 8
python3 ingest/duluth_agendas/parse_cases.py
```
